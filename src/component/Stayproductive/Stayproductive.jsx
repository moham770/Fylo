  ...
  <div className="container">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-9 md:gap-4 place-items-center">
        <div className="StayproductiveImg">
            <img src="public/images/illustration-stay-productive.png" alt="Stayproductive" />
        </div>
...
See how Fylo works
<img src="public/images/icon-arrow.svg" className='w-[20px] h-[20px] ml-1 object-cover animate-movingRight' alt="" />
</a>
